...
public class ThreadStatesPractice implements Runnable {
    public static Thread thread1;
    public static ThreadStatesPractice obj;

    public static void main(String[] args)
    {
        obj = new ThreadStatesPractice();
    ...
    public void run()
    {
        ...
        System.out.println(
                "State of thread1 while it called join() method on thread2 -"
                        + ThreadStatesPractice.thread1.getState());
        try {
            Thread.sleep(200);
        }
        catch (InterruptedException e) {
